...
const eduData = [
  {
      ...
      content: "Bachelor of Technology in Computer Science and Engineering (CSE) - Internet of Things (IoT) | Focused on full-stack development, cloud computing (AWS/Azure), embedded systems programming, and leveraging data structures and algorithms in IoT solutions."
  },
  {
      id: 2,
      title: "Don Bosco School",
      content: "Completed Secondary (10th) and Higher Secondary (12th) education with a focus on Science (PCM)."
  },
];
...
return (
    <div className="min-h-screen bg-gradient-to-br from-blue-950 to-gray-900 text-white">
      ...
      <section id="bio">
        <h1 className='text-center text-6xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-cyan-400 leading-relaxed  min-[375px]:text-4xl'>My Portfolio
        </h1>
      ...
      <section id="projects">
        <div className='text-center mt-3 text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-700 to-blue-800'>Projects</div>
        <Projects />
      </section>
